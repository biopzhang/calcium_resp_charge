...
set ca3 [atomselect top "resid 176"]
set idxca3 [$ca3 get index]
set nearbyOW [atomselect top "name OW and within 3 of resid 176" frame $frame]
...
#    }
    ...
    set sel [atomselect top "resid 93 to 104 or resid 176 $idx3" frame $frame]
